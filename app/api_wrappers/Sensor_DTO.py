...
class SensorDTO:
    ...
    @staticmethod
    def from_json_list(sensor_id: str, values: list) -> Any:
        """Factory method to create SensorDTO from json list and bounding box geometry string.
        :param sensor_id: sensor id
        ...
        for sensor_dict in values:
            dfList.append(SensorDTO.JsonStringToDataframe(sensor_dict["json_"], sensor_dict["boundingBox"]))
